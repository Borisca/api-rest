...
public class FpgApiUserResource {
	...
	//
	 ...
	 public ResponseEntity add(@RequestParam Long id, @RequestParam String name, @RequestParam String email, @RequestParam String mDP , @RequestParam String firstName,@RequestParam String codePostal) throws Exception {
